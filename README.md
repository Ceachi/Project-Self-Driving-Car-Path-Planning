...
### Summary.
This project, will simulate a virtual highway with plenty of cars running with (-10,10) speed mph, with a speed limit of 50.  
...
The project will come: with a list of waypoints around the highway and for all the cars, localization and sensor fusion are already provided.  

This implementation can run at least 10 miles / 14 minutes without incident.


### Implementation

* I used the header file spline.h from this page [spline.h] (https://kluge.in-chemnitz.de/opensource/spline/)  
* The rest of the implemantation was completed in [main.cpp] (./src/main.cpp). Beside the helper functions provided by Udacity, I implemented the telemetry section of the function h.onMessage, between lines 233-445.

* My implementation involves the "cubic splines" to generate smoot trajectories [cubic splines] (https://en.wikipedia.org/wiki/Spline_(mathematics)), this is similar to an implementation provided in [Udacity's wallk-through video] (https://www.youtube.com/watch?v=7sI3VHFPP0w).  
